    ...
    <>
      ...
      {!open && (
        <button
          ...
          title="내 보유 보기"
          className="gold-frame panel-glass fixed right-0 top-1/2 z-[55] flex -translate-y-1/2 flex-col items-center gap-1 rounded-l-xl px-2 py-3 text-gold transition hover:brightness-110"
        >
          <Wallet size={18} />
      ...
      <div
        className={clsx(
          "fixed right-0 top-0 z-[65] h-full w-[400px] max-w-[94vw] overflow-y-auto thin-scroll p-3 transition-transform duration-300 ease-out",
